...
planting_date = '06-01-2022'  # '06-17-2020' , '06-05-2020'
AdjJul_31 = '07-31-2022'

MaturityData = read.csv("C:/Users/leoag/Michigan State University/MSU Dry Bean Breeding Lab - General/UAS_Beans/2022/SVREC_Mat/h._VIs_Method2/VIs/2022_SVREC_RGB_VIs.csv",h=T) 
...
MaturityData_sel1 = MaturityData_sel1 %>% 
  filter(!row_number() %in% c(1, 2, 4, 6, 7))
