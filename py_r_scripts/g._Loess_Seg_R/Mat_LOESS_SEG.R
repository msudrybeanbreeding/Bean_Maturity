...
DPM_Model = 'SEG' # 'SEG' , 'LOESS'
rgb_idx = "GLI" 
vi_method = 'mean'
threshold <- as.numeric(0.06)
planting_date = '06-05-2020'  # '06-17-2020' , '06-05-2020'
AdjJul_31 = '07-31-2020'

MaturityData = read.csv("C:/Users/leoag/Michigan State University/MSU Dry Bean Breeding Lab - General/UAS_Beans/2020/SVREC_Mat/h._VIs_Method2/VIs/2020_SVREC_RGB_VIs.csv",h=T) #ONLY FOR TEST THE 90 PLOTS
...
MaturityData1 <- MaturityData %>% 
  filter(str_detect(Trial, '2001|2002'))

MaturityData2 <- MaturityData %>% 
  filter(str_detect(Trial, '2003|2004'))

str(MaturityData1)

MaturityData_sel1 = MaturityData1 %>% 
